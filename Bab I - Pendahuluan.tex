...
yang membakar 2,6 hektare hutan dan lahan yang dipicu oleh kekeringan akibat El Niño pada tahun 2015. 
...
Namun, studi oleh \textcite{} menemukan bahwa data VIIRS hanya menemukan sekitar 52-53\% kejadian lapangan yang memiliki \textit{hotspot}, 
...
Adapun untuk batasan masalah dalam pengerjaan tugas akhir ini adalah sebagai ber-
ikut.
...
\begin{enumerate}
	...
	digunakan pada evaluasi model, termasuk Accuracy, Precision, Recall, F1-Score, serta Area Under ROC Curve (AUC-ROC). 

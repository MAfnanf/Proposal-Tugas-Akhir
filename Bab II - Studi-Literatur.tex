...
\end{equation}
Pada Persamaan~\ref{eq:xgboost-boost}, $F_0(x)$ biasanya berupa model awal 
...
\subsection{SHAP}
SHAP (\textit{SHapley Additive Explanations}) merupakan salah satu metode XAI yang paling populer untuk menjelaskan prediksi model \textit{machine learning}. Sebagai contoh,
pada penelitian \textcite{Abdollahi2023}, penggunaan SHAP yang dikombinasikan dengan \textit{machine learning} dapat menghasilkan sebuah pemetaan kerentanan kebakaran hutan. Penelitian
...
Papua. Mereka mengembangkan sebuah algoritma \textit{machine learning} termasuk RF dan XGBoost dari lima belas faktor kerentanan, seperti 
...
dan topografi. Mereka menggunakan model \textit{deep learning} untuk memprediksi kerentanan kebakaran hutan lalu menerapkan metode SHAP untuk menafsirkan kontribusi masing-masing
...
\textit{machine learning} dan XAI pada kasus kebakaran hutan dan lahan. Namun,

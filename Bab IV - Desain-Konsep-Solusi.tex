...
\begin{enumerate}
    ...
    dalam satuan waktu bulanan sehingga setiap rekaman merepresentasikan kombinasi \textit{grid}-bulan. Skala
    ...
    memiliki titik api atau tidak. Hasil tahap ini adalah \textit{dataset} bulanan per \textit{grid} yang siap digunakan
    ...
    biofisik, dan antropogenik. \textit{Output} utama dari model ini adalah skor atau kelas (level) risiko karhutla bulanan untuk setiap 
    ...
    model tidak sekadar sebuah hasil. Namun, hasil yang diberikan disertai penjelasan sehingga analisis lanjutan mungkin 
...
\begin{table}[h]
    ...
    \hline
    Fungsi utama &
    Mendukung \textit{monitoring} dan respon reaktif ketika bahaya sudah tinggi. &

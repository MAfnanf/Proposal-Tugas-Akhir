...
Mengacu pada metodologi CRISP-DM yang telah dijelaskan pada Bab I, rencana implementasi akan dilakukan dengan mengikuti
...
\begin{enumerate}
    ...
    Pada tahap ini, data akan disiapkan agar dapat menjadi data yang bersih untuk dijadikan bahan \textit{training} oleh model prediktif. Output pada tahap ini adalah \textit{dataset} tabular yang terstruktur per kombinasi \textit{grid} dalam kurun waktu bulanan dan siap untuk digunakan pada tahap
    ...
    \begin{enumerate}
        ...
        sehingga memiliki tiga kelas risiko (rendah, sedang, dan tinggi) berdasarkan \textit{threshold} yang akan ditentukan.
...
Hal ini karena XAI berhasil menjadi penjelas dari kondisi \textit{black box} yang dialami oleh model dan dapat membantu pemangku kepentingan dalam memahami kondisi 

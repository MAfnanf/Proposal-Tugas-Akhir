...
lapangan dengan kemampuan sistem dapat terlihat dengan jelas. Kesenjangan inilah yang kemudian
...
hasil interaksi antara variabilitas iklim, kondisi biofisik, dan aktivitas manusia sebagaimana telah dibahas
...
respons reaktif yang cepat di lapangan. Namun dari sudut pandang pengelolaan risiko kebakaran, masih terdapat sejumlah
...
bisa menghambat efektivitas penanggulangan. \textcite{Prayoga2021} juga menilai bahwa alur ini cenderung berorientasi pada respons sehingga 
...
\begin{enumerate}
    ...
    saat ini menggunakan pendekatan FWI menjadi kurang relevan disebabkan hanya bergantung pada satu faktor, yaitu faktor meteorologik.
    ...
    lahan gambut dan saat musim kemarau yang diperkuat dengan fenomena ENSO. Beberapa kawasan mengalami kebakaran berulang, Sementara
    ...
    tetapi juga "mengapa wilayah tersebut memiliki risiko yang tinggi". Saat ini, hubungan antara faktor-faktor penyebab karhutla sering kali
    ...
    Untuk meningkatkan langkah operasional dalam mengendalikan bencana karhutla, pemenuhan sumber daya sering kali menjadi tantangan dalam hal ini. 
...
disertai faktor-faktor apa yang paling berkontribusi. Analisis inilah yang akan menjadi fokus pada tahap selanjutnya dalam tugas akhir untuk menentukan
...
\begin{table}[t]
  \begin{tabular}{| p{1.2cm} | p{4cm} | p{7cm} |}
    ...
    Sistem perlu menyediakan hasil analisis pola dan penyajian informasi analisis untuk memberikan hasil transparansi pola. \\
    \hline
...
Selain itu, pada tugas akhir ini kebutuhan non-fungsional difokuskan pada tiga aspek utama, yaitu akurasi model, ketersediaan dan waktu respons sistem, serta kemudahan penggunaan. 
Akurasi model diperlukan agar informasi risiko yang dihasilkan tidak menyesatkan pengambil keputusan, ketersediaan dan waktu respons menentukan sejauh mana sistem dapat mendukung analisis 
...
\begin{table}[H]
  ...
  \begin{tabular}{| p{1.2cm} | p{3cm} | p{8cm} |}
    ...
    \textit{accuracy} mencapai 0,80 dan \textit{F1-score} pada kelas
    risiko tinggi adalah 0,75. \\ \hline
...
mencari solusi yang secara konseptual dapat membantu memenuhi kebutuhan tersebut. Alternatif-alternatif ini disusun dengan merangkum pendekatan
...
\begin{enumerate}
    ...
    Sistem ini disajikan melalui perhitungan indikator \textit{hotspot} lewat FWI serta antarmuka peta dan grafik di web serta memiliki respons cepat untuk langkah karhutla secara reaktif. Walaupun begitu, sistem ini 
...
yang harus dipertimbangkan. Menurut \textcite{OShea2026}, konsep penentuan solusi dilakukan dengan mendefinisikan kriteria, menentukan bobot pada setiap kriteria, memberikan penilaian terhadap setiap
...
Data FIRMS diperoleh dalam format \textit{shapefile} (shp) yang dikonversi ke file \textit{Comma Separated Values} (csv) dengan
...
dengan 15 fitur utama yang mencakup periode observasi dari 1 April 2018 sampai 1 Januari 2023. Pemilihan lokasi data berfokus pada
...
berdasarkan data tahunan. Distribusi jumlah \textit{hotspot} per tahun ditunjukkan pada Gambar \ref{gambar:persebaran-VIIRS}
\begin{figure}[h] % pilihan opsi yang disarankan: t = top, b = bottom, h = here
	\centering
  \captionsetup{justification=centering}
...
Pada Gambar \ref{gambar:persebaran-VIIRS}, jumlah data \textit{hotspot} yang terjadi pada tahun 2023 sangat kecil. Hal ini tidak sejalan dengan pola tahunan
sebelumnya maupun statistik kebakaran dari sumber resmi yang ditunjukkan pada Bab 1. Hal ini bisa jadi mengindikasikan 
...
namun hanya percikan api yang mungkin disebabkan oleh aktivitas manusia. Distribusi intensitas api ditunjukkan pada Gambar \ref{gambar:persebaran-confidence}.
\begin{figure}[h] % pilihan opsi yang disarankan: t = top, b = bottom, h = here
	\centering
  \captionsetup{justification=centering}

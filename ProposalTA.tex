...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN SISTEM PREDIKSI RISIKO TERJADINYA KEBAKARAN HUTAN DAN LAHAN DI INDONESIA BERBASIS \textit{MACHINE LEARNING} DAN \textit{EXPLAINABLE AI}}\\
     \vspace{4cm}

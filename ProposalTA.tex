...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN SISTEM PREDIKSI POTENSI KEBAKARAN HUTAN DI INDONESIA BERBASIS \textit{MACHINE LEARNING} DAN \textit{EXPLAINABLE ARTIFICIAL INTELLIGENCE}}\\
     \vspace{4cm}
